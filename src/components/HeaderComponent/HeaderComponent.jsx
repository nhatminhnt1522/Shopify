    ...
    return (
        <div style={{ heiht: '100%', width: '100%', display: 'flex', background: '#9255FD', justifyContent: 'center' }}>
            <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
                <Col span={5}>
                    <WrapperTextHeader to='/'>SHOPIFY</WrapperTextHeader>
                </Col>
                {!isHiddenSearch && (
                    <Col span={13}>
                        <ButttonInputSearch
                ...
                <Col span={6} style={{ display: 'flex', gap: '54px', alignItems: 'center' }}>
                    ...
                    {!isHiddenCart && (
                        <div onClick={() => navigate('/order')} style={{ cursor: 'pointer' }} className='flex justify-center items-center'>
                            <Badge count={order?.orderItems?.length} size="small" className='mr-2'>
